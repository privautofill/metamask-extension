...
<details><summary><b>getWindowTitleByHandleId</b></summary>

> **`getWindowTitleByHandleId`** function changes to a specific window tab using its ID and gets its title.
>
...
>
> ```jsx
> const fullScreenWindowTitle = await driver.getWindowTitleByHandleId(
>   windowHandles[0],
> );
> ```
